...
function App() {
  ...
  const [settingsTab, setSettingsTab] = useState<"general" | "about" | "organization" | "keyboard" | "macros" | "dictionary" | "emoji" | "colors" | "storage" | "security" | "markdown" | undefined>(undefined);
